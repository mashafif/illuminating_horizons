...
def download_gdf(
    ...
    if country in countries:
        ...
        temppath = '../raw_data/gadm_gdf/country_ISO.json'
        root_path = os.path.dirname(os.path.dirname(__file__))
        json_path = os.path.join(root_path,"raw_data","country_ISO.json")
        ...
        #gdf.to_netcdf(f'../raw_data/bm/blackmarble_2023_{alpha3_to_alpha2[country]}.nc')
        #print(f'Light data for {country} saved to local')
    return gdf
